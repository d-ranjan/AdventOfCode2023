...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 1320);
    test_equal(part_one::get_result(input::data), 519041);
    test_equal(part_two::get_result(input::test), 145);
    test_equal(part_two::get_result(input::data), 260530);
