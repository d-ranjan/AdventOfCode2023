...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 288);
    test_equal(part_one::get_result(input::data), 32076);
    test_equal(part_two::get_result(input::test), 71503);
    test_equal(part_two::get_result(input::data), 34278221);
