...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 8);
    test_equal(part_one::get_result(input::data), 2256);
    test_equal(part_two::get_result(input::test), 2286);
    test_equal(part_two::get_result(input::data), 74229);
