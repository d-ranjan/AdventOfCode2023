...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 374);
    test_equal(part_one::get_result(input::data), 9639160);
    test_equal(part_two::get_result(input::test), 82000210);
    test_equal(part_two::get_result(input::data), 752936133304);
