...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 114);
    test_equal(part_one::get_result(input::data), 1666172641);
    test_equal(part_two::get_result(input::test), 2);
    test_equal(part_two::get_result(input::data), 933);
