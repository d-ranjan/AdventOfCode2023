...
int main()
{
    ...
    test_equal(part_one::get_result(input::test), 6440);
    test_equal(part_one::get_result(input::data), 248812215);
    test_equal(part_two::get_result(input::test), 5905);
    test_equal(part_two::get_result(input::data), 250057090);
